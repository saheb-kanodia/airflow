...
class RotatingFileTaskHandler(logging.Handler):
    ...
    def __init__(self, base_log_folder, filename_template,
        ...
        self.handler = None  # type: Optional[TimedRotatingFileHandler]
        self.local_base = base_log_folder
        self.interval = interval
        self.backup_count = backup_count
        # filename, when='h', interval=1, backupCount=0
        super(RotatingFileTaskHandler, self).__init__()
    ...
    def set_context(self, ti):
        ...
        self.handler = TimedRotatingFileHandler(local_loc, when='M', interval=self.interval,
